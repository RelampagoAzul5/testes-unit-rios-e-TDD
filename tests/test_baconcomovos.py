...
class TestBaconComOvos(unittest.TestCase):
    ...
    def test_bacon_com_ovos_deve_retornar_bacon_se_entrada_for_multiplo_apenas_de_3(self):
        entradas = (3,6,9,12)
        saida = 'Bacon'
        ...
        for entrada in entradas:
            with self.subTest(entrada=entrada, saida=saida):
                self.assertEqual(bacon_com_ovos(entrada),saida)
    def test_bacon_com_ovos_deve_retornar_ovos_se_entrada_for_multiplo_apenas_de_5(self):
        entradas = (5,10,20,25)
        saida = 'Ovos'
